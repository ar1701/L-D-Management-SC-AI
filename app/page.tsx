    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">LearnDemo Pro</span>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Streamline your Learning & Development programs and manage demo accounts with ease. Get 5 hours free monthly
            for L&D, plus 10-day demo access for prospects.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register?type=ld">
              <Button size="lg" className="px-8">
                Start L&D Free Trial
              </Button>
            </Link>
            <Link href="/register?type=demo">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Two Powerful Solutions</h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="p-6">
              <CardHeader>
                ...
                <CardDescription>Complete learning and development platform for your organization</CardDescription>
              </CardHeader>
            ...
            <Card className="p-6">
              <CardHeader>
                ...
                <CardDescription>10-day trial access to explore our platform capabilities</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">© 2024 LearnDemo Pro. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
